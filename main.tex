...
\author{Daniel Liew, Henry Addison \& Ruby Childs}
...
\section{Equivalences}
	...
	\begin{equation*}
		...
		\fa \lnot A \lor B & \giv \\ %1
			\fa\fh A & \ass \\ %2 
			\fa\fa \lnot\lnot A & \alem{sec:double-negation-rule}{2} \\ %3 
			\fa\fa B & \orE{1}{3}\\ %4
	...
	\begin{equation*}
		\begin{fitch}
			...
			\fa A \lor B & \alem{sec:aimpliesB}{5} \\ %6
				\fa\fh \lnot A & \ass \\ %7
				\fa\fa B \land C & \orE{1}{7} \\ %8
				\fa\fa C & \andE{8} \\ %9
			\fa \lnot A \to C & \arrowI{7}{9} \\ %10
			\fa A \lor C & \alem{sec:aimpliesB}{10} \\ %11
	...
	\begin{equation*}
		\begin{fitch}
			...
			\fa A \lor (B \land C) & \alem{sec:aimpliesB}{8} \\
		\end{fitch}
	\end{equation*}
	...
	\begin{equation*}
		\begin{fitch}
			\fa A \land (B \lor C)  & \giv \\ %1
				...
				\fa\fa \lnot(A \land B) \land \lnot(A \land C) & \alem{sec:demorganor}{2}\\ %5
...
\section{Additional inference rules}
	...
	\begin{equation*}
		\begin{fitch}
				...
				\fa\fa \lnot A \land A & \alem{sec:demorganor}{1} \\ %2
	...
	Alternative proof not relying on a lemma. Provided by Ruby Childs.
	\begin{equation*}
		\begin{fitch}
				\fa\fh \lnot( A \lor \lnot A) & \ass \\ %1
					\fa\fa\fh \lnot A & \ass \\ %2
					\fa\fa\fa A \lor \lnot A & \orI{2} \\ %3
				\fa\fa A & \raa{2}{1}{3} \\ %4
				\fa\fa A \lor \lnot A & \orI{4} \\ %5
			A \lor \lnot A & \raa{1}{1}{5} \\ %6
		\end{fitch}
	\end{equation*}
...
\section{Predicate Logic Equivalences}
  ...
  $ \lnot \forall X p(X) \vdash \exists X \lnot p(X) $
	  \begin{equation*}
		  \begin{fitch}
		    \fa \lnot \forall X p(X) & \giv \\ %1
		      \fa \fh \lnot \exists X \lnot p(X) & \ass \\ %2
		        \fa \fa \fh \lnot p(a) & \ass \\ %3
		        \fa \fa \fa \exists X \lnot p(X) & \existsI{3} \\ %4
		      \fa \fa p(a) & \raa{3}{2}{4} \\ %5
		      \fa \fa \forall X p(X) & \forallI{5} - since assumption in 3 has now been discharged, $a$ is just an arbitrary constant\\ %6
  ...
  $ \exists X \lnot p(X) \vdash \lnot \forall X p(X) $
    \begin{equation*}
  	  \begin{fitch}
        \fa \exists X \lnot p(X) & \giv \\ %1
          \fa \fh \forall X p(X) & \ass \\ %2
            \fa \fa \fh \lnot p(a) & \ass \\ %3
              \fa \fa \fa \fh \exists X \lnot p(X) & \ass \\ %4
              \fa \fa \fa \fa p(a) & \forallE{2} \\ %5
            \fa \fa \fa \lnot \exists X \lnot p(X) & \raa{4}{3}{5} \\ %6
          \fa \fa \lnot \exists X \lnot p(X) & \existsE{1}{3}{6} \\ %7
        \fa \lnot \forall X p(X) & \raa{2}{1}{7} \\ %8
      \end{fitch}
  	\end{equation*}
\end{document}